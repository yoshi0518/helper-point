    ...
    <div className="flex w-full">
      <nav className="flex w-64 flex-col border-r bg-white">
        ...
        <div className="space-y-2 p-3">
          <Button
            variant="ghost"
            className="block flex h-12 w-full cursor-pointer items-center justify-start bg-blue-100 text-left text-blue-800"
          >
            <House />
            Home
          </Button>
          <Button
            variant="ghost"
            className="block flex h-12 w-full cursor-pointer items-center justify-start text-left hover:bg-gray-100"
          >
            <ListChecks />
            お手伝い登録
          </Button>
